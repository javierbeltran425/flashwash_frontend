...
const Products = () => {
    return(
        ...
        <div className="flex w-full h-screen overflow-hidden justify-center items-center bg-gray-800">
                ...
                <SideBar/>
                <div className="lg:hidden flex justify-center w-auto h-1/2 mb-20 md:hidden lg:hidden">
                    <GenCard />
                </div>
                <div className="hidden lg:inline m-10 lg:px-48 mx-auto p-16 sm:p-24 absolute ">
                    {/* Carousel Body */}
